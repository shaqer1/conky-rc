...
os.system('python3 ~/conkyConfigs/ListMD/mdToPython.py /home/shafay/conkyConfigs/ListMD/hw.md | lynx --dump -stdin | fold -s -w 40 > /home/shafay/conkyConfigs/ListMD/hwText')
...
with open('/home/shafay/conkyConfigs/ListMD/output') as f:
    print(f.read())
